...
public class DriveSubsystem extends SubsystemBase {
  ...
  public enum FieldPosition {
    ...
    // For driving to reef
    ONE(new Pose2d(new Translation2d(6.21, 4.004), Rotation2d.fromDegrees(0)), true, "1"),
    TWO(new Pose2d(new Translation2d(5.379, 2.498), Rotation2d.fromDegrees(-60)), false, "2"),
    THREE(new Pose2d(new Translation2d(5.379, 2.498), Rotation2d.fromDegrees(-60)), true, "3"),
    FOUR(new Pose2d(new Translation2d(3.604, 2.498), Rotation2d.fromDegrees(-120)), false, "4"),
